function listenNav() {
  ...
  document.addEventListener("keydown", function (t) {
    ...
    if (s) {
      let o = e,
        n = document.querySelectorAll(".selector li"),
        s = n.length;
      switch (t.key) {
        case "ArrowUp":
          (n[e].classList.remove("highlight"),
            (e = (e - 1 + s) % s),
            t.preventDefault());
          break;
        case "ArrowDown":
      ...
      if (o !== e) {
        const t = `/projects/${e}`;
        (htmx.ajax("GET", t, { target: "#project-box" }),
          n[e].classList.add("highlight"));
      }
    }
...
function dragElement(e) {
  var s = 0,
    ...
    t = 0,
    n = 0;
  document.getElementById(e.id + "-decorations").onmousedown = i;
  function i(e) {
    ((e = e || window),
      e.preventDefault(),
      (t = e.clientX),
